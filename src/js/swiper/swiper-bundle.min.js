!function(e, t) {
    ...
    class l extends Array {
        constructor(e)
        {
            var t;
            let s;
            "number" == typeof e ? super(e) : (super(...e || []), t = this, s = t.__proto__, Object.defineProperty(t, "__proto__", {
                get: () => s,
                set(e) {
                    s.__proto__ = e
                }
    ...
    let p = {
        ...
        on: function() {
            ...
            function n(e) {
                ...
                if (0 > s.indexOf(e) && s.unshift(e), d(t).is(i))
                    r.apply(t, s);
                else {
                    let a = d(t).parents();
                    for (let l = 0; l < a.length; l += 1)
                        d(a[l]).is(i) && r.apply(a[l], s)
                }
            }
            function o(e) {
            ...
            "function" == typeof t[1] && ([a, r, l] = t, i = void 0),
            l || (l = !1);
            let p = a.split(" "),
                c;
            for (let u = 0; u < this.length; u += 1) {
                ...
                if (i)
                    for (c = 0; c < p.length; c += 1) {
                        ...
                        m.dom7LiveListeners[h] || (m.dom7LiveListeners[h] = []),
                        m.dom7LiveListeners[h].push({
                            listener: r,
                            proxyListener: n
                        }),
            ...
            for (let n = 0; n < i.length; n += 1) {
                ...
                for (let d = 0; d < this.length; d += 1) {
                    ...
                    if (e.CustomEvent) {
                        ...
                        p.dom7EventData = s.filter((e, t) => t > 0),
                        p.dispatchEvent(c),
                        p.dom7EventData = [],
    ...
    function m(e, t) {
        ...
        let a,
            ...
            o,
            d,
            p = (s = e, (a = r()).getComputedStyle && (i = a.getComputedStyle(s, null)), !i && s.currentStyle && (i = s.currentStyle), i || (i = s.style), i);
        return l.WebKitCSSMatrix ? ((o = p.transform || p.webkitTransform).split(",").length > 6 && (o = o.split(", ").map(e => e.replace(",", ".")).join(", ")), d = new l.WebKitCSSMatrix("none" === o ? "" : o)) : n = (d = p.MozTransform || p.OTransform || p.MsTransform || p.msTransform || p.transform || p.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")).toString().split(","), "x" === t && (o = l.WebKitCSSMatrix ? d.m41 : 16 === n.length ? parseFloat(n[12]) : parseFloat(n[4])), "y" === t && (o = l.WebKitCSSMatrix ? d.m42 : 16 === n.length ? parseFloat(n[13]) : parseFloat(n[5])), o || 0
    }
    function h(e) {
    ...
    function v(e) {
        ...
        let p = s > l ? "next" : "prev",
            ...
            u = () => {
                n = new Date().getTime(),
                null === o && (o = n);
                let e = l + (.5 - Math.cos(Math.max(Math.min((n - o) / d, 1), 0) * Math.PI) / 2) * (s - l);
                if (c(e, s) && (e = s), t.wrapperEl.scrollTo({
                    [a]: e
                }), c(e, s))
    ...
    function x() {
        let e,
            t;
        return w || (w = (e = r(), {
            smoothScroll: (t = a()).documentElement && "scrollBehavior" in t.documentElement.style,
    ...
    function E(e) {
        ...
        if (!p || t.animating && n.preventInteractionOnTransition)
            return;
        !t.animating && n.cssMode && n.loop && t.loopFix();
        let c = e;
        c.originalEvent && (c = c.originalEvent);
        let m = d(c.target);
        if ("wrapper" === n.touchEventsTarget && !m.closest(t.wrapperEl).length || (l.isTouchEvent = "touchstart" === c.type, !l.isTouchEvent && "which" in c && 3 === c.which) || !l.isTouchEvent && "button" in c && c.button > 0 || l.isTouched && l.isMoved)
            return;
        ...
        if (n.swipeHandler && !m.closest(n.swipeHandler)[0])
            return;
        ...
        if (Object.assign(l, {
            ...
            let x = !0;
            m.is(l.focusableElements) && (x = !1, "SELECT" === m[0].nodeName && (l.isTouched = !1)),
            s.activeElement && d(s.activeElement).is(l.focusableElements) && s.activeElement !== m[0] && s.activeElement.blur();
    ...
    function C(e) {
        ...
        if (p.preventedByNestedSwiper)
            return l.startX = m, void (l.startY = h);
        if (!s.allowTouchMove)
            return d(p.target).is(i.focusableElements) || (s.allowClick = !1), void (i.isTouched && (Object.assign(l, {
                startX: m,
                startY: h,
                currentX: m,
                currentY: h
        ...
        if (i.isTouchEvent && r.touchReleaseOnEdges && !r.loop) {
            if (s.isVertical()) {
                if (h < l.startY && s.translate <= s.maxTranslate() || h > l.startY && s.translate >= s.minTranslate())
                    return i.isTouched = !1, void (i.isMoved = !1)
            } else if (m < l.startX && s.translate <= s.maxTranslate() || m > l.startX && s.translate >= s.minTranslate())
                return
        }
        ...
        if (i.isScrolling && s.emit("touchMoveOpposite", p), void 0 === i.startMoving && (l.currentX === l.startX && l.currentY === l.startY || (i.startMoving = !0)), i.isScrolling)
    ...
    function T(e) {
        ...
        if (t.allowClick) {
            ...
            t.updateClickedSlide(m && m[0] || o.target),
            t.emit("tap click", o),
    ...
    function k() {
        ...
        (i = 0 === r ? 0 : (e.translate - e.minTranslate()) / r) !== e.progress && e.updateProgress(s ? -e.translate : e.translate),
    ...
    let L = (e, t) => {
            ...
            if (d.touch) {
                ...
                l[c](r.move, e.onTouchMove, d.passiveListener ? {
                    passive: !1,
                    capture: p
                } : p),
    ...
    let O = {
            ...
            update: {
                updateSize: function() {
                    ...
                    0 === e && this.isHorizontal() || 0 === t && this.isVertical() || (e = e - parseInt(s.css("padding-left") || 0, 10) - parseInt(s.css("padding-right") || 0, 10), t = t - parseInt(s.css("padding-top") || 0, 10) - parseInt(s.css("padding-bottom") || 0, 10), Number.isNaN(e) && (e = 0), Number.isNaN(t) && (t = 0), Object.assign(this, {
                        width: e,
                        height: t,
                ...
                updateSlides: function() {
                    ...
                    for (let S = 0; S < c; S += 1) {
                        ...
                        if (E && e.grid.updateSlide(S, P, c, t), "none" !== P.css("display")) {
                            if ("auto" === a.slidesPerView) {
                                ...
                                if (M && (P[0].style.transform = "none"), z && (P[0].style.webkitTransform = "none"), a.roundLengths)
                                ...
                                a.roundLengths && (C = Math.floor(C)),
                                p[S] && (p[S].style[t("width")] = `${C}px`);
                            p[S] && (p[S].swiperSlideSize = C),
                            h.push(C),
                            a.centeredSlides ? (_ = _ + C / 2 + x / 2 + b, 0 === x && 0 !== S && (_ = _ - r / 2 - b), 0 === S && (_ = _ - r / 2 - b), .001 > Math.abs(_) && (_ = 0), a.roundLengths && (_ = Math.floor(_)), y % a.slidesPerGroup == 0 && u.push(_), m.push(_)) : (a.roundLengths && (_ = Math.floor(_)), (y - Math.min(e.params.slidesPerGroupSkip, y)) % e.params.slidesPerGroup == 0 && u.push(_), m.push(_), _ = _ + C + b),
                            e.virtualSize += C + b,
                            x = C,
                            y += 1
                        }
                    ...
                    if (Object.assign(e, {
                        ...
                        $(e.wrapperEl, "--swiper-centered-offset-after", e.size / 2 - h[h.length - 1] / 2 + "px");
                        let j = -e.snapGrid[0],
                            U = -e.slidesGrid[0];
                ...
                updateSlidesClasses: function() {
                    ...
                    t.loop && (l.hasClass(t.slideDuplicateClass) ? s.children(`.${t.slideClass}:not(.${t.slideDuplicateClass})[data-swiper-slide-index="${i}"]`).addClass(t.slideDuplicateActiveClass) : s.children(`.${t.slideClass}.${t.slideDuplicateClass}[data-swiper-slide-index="${i}"]`).addClass(t.slideDuplicateActiveClass));
            ...
            translate: {
                ...
                setTranslate: function(e, t) {
                    ...
                    (o = 0 === c ? 0 : (e - s.minTranslate()) / c) !== n && s.updateProgress(e),
            ...
            slide: {
                slideTo: function(e, t, s, a, i) {
                    ...
                    if (l.animating && o.preventInteractionOnTransition || !f && !a && !i)
                        return !1;
                    ...
                    if (l.initialized && n !== u && (!l.allowSlideNext && w < l.translate && w < l.minTranslate() || !l.allowSlidePrev && w > l.translate && w > l.maxTranslate() && (u || 0) !== n))
                        return !1;
                    let E;
                ...
                slidePrev: function(e, t, s) {
                    ...
                    let c = p(o ? a.translate : -a.translate),
                        u = l[l.map(e => p(e)).indexOf(c) - 1];
                    if (void 0 === u && i.cssMode) {
                        let m;
                        l.forEach((e, t) => {
                            c >= e && (m = t)
                        }),
                        void 0 !== m && (u = l[m > 0 ? m - 1 : m])
                    }
                    let h = 0;
                    if (void 0 !== u && ((h = n.indexOf(u)) < 0 && (h = a.activeIndex - 1), "auto" === i.slidesPerView && 1 === i.slidesPerGroup && i.slidesPerGroupAuto && (h = Math.max(h = h - a.slidesPerViewDynamic("previous", !0) + 1, 0))), i.rewind && a.isBeginning) {
                        let f = a.params.virtual && a.params.virtual.enabled && a.virtual ? a.virtual.slides.length - 1 : a.slides.length - 1;
            ...
            loop: {
                loopCreate: function() {
                    ...
                    for (let m = 0; m < e.loopedSlides; m += 1) {
                        ...
                        u.push(l.eq(h)[0]),
                        c.unshift(l.eq(l.length - h - 1)[0])
                    }
                    for (let f = 0; f < u.length; f += 1)
                        r.append(d(u[f].cloneNode(!0)).addClass(s.slideDuplicateClass));
                    for (let g = c.length - 1; g >= 0; g -= 1)
                        r.prepend(d(c[g].cloneNode(!0)).addClass(s.slideDuplicateClass))
                },
                loopFix: function() {
                    let e = this;
                    ...
                    t < a ? (o = s.length - 3 * a + t, o += a, e.slideTo(o, 0, !1, !0) && 0 !== d && e.setTranslate((n ? -e.translate : e.translate) - d)) : t >= s.length - a && (o = -s.length + t + a, o += a, e.slideTo(o, 0, !1, !0) && 0 !== d && e.setTranslate((n ? -e.translate : e.translate) - d)),
                    e.allowSlidePrev = i,
                    e.allowSlideNext = r,
                    e.emit("loopFix")
                },
            ...
            classes: {
                addClasses: function() {
                    var e,
                        t;
                    let s,
                        {classNames: a, params: i, rtl: r, $el: l, device: n, support: o} = this,
    ...
    class G {
        constructor()
        {
            let e,
                t;
            for (var s, a = arguments.length, i = Array(a), l = 0; l < a; l++)
                i[l] = arguments[l];
            ...
            o.browser = (_ || (_ = {
                isSafari: (c = (p = r()).navigator.userAgent.toLowerCase()).indexOf("safari") >= 0 && 0 > c.indexOf("chrome") && 0 > c.indexOf("android"),
            ...
            o.modules.forEach(e => {
                ...
                e({
                    swiper: o,
                    extendParams: (s = t, a = m, function(e) {
                        void 0 === e && (e = {});
            ...
            let h = g({}, D, m),
                f,
                $;
            return o.params = g({}, h, A, t), o.originalParams = g({}, o.params), o.passedParams = g({}, t), o.params && o.params.on && Object.keys(o.params.on).forEach(e => {
                ...
                touchEvents: (f = ["touchstart", "touchmove", "touchend", "touchcancel"], $ = ["pointerdown", "pointermove", "pointerup"], o.touchEventsTouch = {
                    start: f[0],
                    move: f[1],
                    end: f[2],
                    cancel: f[3]
        ...
        slidesPerViewDynamic(e, t)
        {
            ...
            if (s.centeredSlides) {
                ...
                for (let c = n + 1; c < a.length; c += 1)
                    a[c] && !d && (p += a[c].swiperSlideSize, o += 1, p > l && (d = !0));
                for (let u = n - 1; u >= 0; u -= 1)
                    a[u] && !d && (p += a[u].swiperSlideSize, o += 1, p > l && (d = !0))
            } else if ("current" === e)
        ...
        update()
        {
            ...
            e.updateProgress(),
            e.updateSlidesClasses(),
            e.params.freeMode && e.params.freeMode.enabled ? (a(), e.params.autoHeight && e.updateAutoHeight()) : (i = ("auto" === e.params.slidesPerView || e.params.slidesPerView > 1) && e.isEnd && !e.params.centeredSlides ? e.slideTo(e.slides.length - 1, 0, !1, !0) : e.slideTo(e.activeIndex, 0, !1, !0)) || a(),
        ...
        destroy(e, t)
        {
            ...
            void 0 === t && (t = !0);
            let a = this,
                {params: i, $el: r, $wrapperEl: l, slides: n} = a,
                o;
            return void 0 === a.params || a.destroyed || (a.emit("beforeDestroy"), a.initialized = !1, a.detachEvents(), i.loop && a.loopDestroy(), t && (a.removeClasses(), r.removeAttr("style"), l.removeAttr("style"), n && n.length && n.removeClass([i.slideVisibleClass, i.slideActiveClass, i.slideNextClass, i.slidePrevClass, ].join(" ")).removeAttr("style").removeAttr("data-swiper-slide-index")), a.emit("destroy"), Object.keys(a.eventsListeners).forEach(e => {
                a.off(e)
            }), !1 !== e && (a.$el[0].swiper = null, Object.keys(o = a).forEach(e => {
                try {
                    o[e] = null
                } catch (t) {}
                try {
    ...
    function B(e, t, s, i) {
        ...
        return e.params.createElements && Object.keys(i).forEach(a => {
            if (!s[a] && !0 === s.auto) {
                ...
                l || ((l = r.createElement("div")).className = i[a], e.$el.append(l)),
                s[a] = l,
                t[a] = l
            }
        }), s
    ...
    let U = [function(e) {
        ...
        function n(e) {
            ...
            i ? (g = Math.floor(t / 2) + a + o, $ = Math.floor(t / 2) + a + n) : (g = t + (a - 1) + o, $ = a + n);
        ...
        function p(e) {
            ...
            let i = a.keyCode || a.charCode,
                ...
                m = 38 === i,
                h = 40 === i;
            if (!t.allowSlideNext && (t.isHorizontal() && u || t.isVertical() && h || p) || !t.allowSlidePrev && (t.isHorizontal() && c || t.isVertical() && m || d))
                return !1;
            if (!(a.shiftKey || a.altKey || a.ctrlKey || a.metaKey || n.activeElement && n.activeElement.nodeName && ("input" === n.activeElement.nodeName.toLowerCase() || "textarea" === n.activeElement.nodeName.toLowerCase()))) {
                if (t.params.keyboard.onlyInViewport && (d || p || c || u || m || h)) {
                    ...
                    let x = [[_.left, _.top], [_.left + $, _.top], [_.left, _.top + v], [_.left + $, _.top + v], ];
                ...
                t.isHorizontal() ? ((d || p || c || u) && (a.preventDefault ? a.preventDefault() : a.returnValue = !1), ((p || u) && !s || (d || c) && s) && t.slideNext(), ((d || c) && !s || (p || u) && s) && t.slidePrev()) : ((d || p || m || h) && (a.preventDefault ? a.preventDefault() : a.returnValue = !1), (p || h) && t.slideNext(), (d || m) && t.slidePrev()),
                l("keyPress", i)
            }
        }
        function c() {
        ...
        function $(e) {
            ...
            let p = t.$el;
            if ("container" !== t.params.mousewheel.eventsTarget && (p = d(t.params.mousewheel.eventsTarget)), !t.mouseEntered && !p[0].contains(a.target) && !l.releaseOnEdges)
                return !0;
            a.originalEvent && (a = a.originalEvent);
            let h = 0,
                f,
            ...
            if (l.forceToAxis) {
                if (t.isHorizontal()) {
                    ...
                    if (!(Math.abs(_.pixelY) > Math.abs(_.pixelX)))
                        return !0;
                    h = -_.pixelY
                }
            } else
                h = Math.abs(_.pixelX) > Math.abs(_.pixelY) ? -_.pixelX * b : -_.pixelY;
            if (0 === h)
                return !0;
            l.invert && (h = -h);
                ...
                if (!E) {
                    ...
                    if (C >= t.minTranslate() && (C = t.minTranslate()), C <= t.maxTranslate() && (C = t.maxTranslate()), t.setTransition(0), t.setTranslate(C), t.updateProgress(), t.updateActiveIndex(), t.updateSlidesClasses(), (!T && t.isBeginning || !S && t.isEnd) && t.updateSlidesClasses(), t.params.freeMode.sticky) {
                        ...
                        let P = m.length ? m[m.length - 1] : void 0,
                            k = m[0];
                        if (m.push(y), P && (y.delta > P.delta || y.direction !== P.direction))
                            m.splice(0);
                    ...
                    if (E || i("scroll", a), t.params.autoplay && t.params.autoplayDisableOnInteraction && t.autoplay.stop(), C === t.minTranslate() || C === t.maxTranslate())
                        return !0
                }
            } else {
                let z = {
        ...
        function u() {
            let {$nextEl: e, $prevEl: s} = t.navigation;
            e && e.length && (e.off("click", p), e.removeClass(t.params.navigation.disabledClass)),
        ...
        function c() {
            ...
            if (t.params.loop ? ((c = Math.ceil((t.activeIndex - t.loopedSlides) / t.params.slidesPerGroup)) > a - 1 - 2 * t.loopedSlides && (c -= a - 2 * t.loopedSlides), c > u - 1 && (c -= u), c < 0 && "bullets" !== t.params.paginationType && (c = u + c)) : c = void 0 !== t.snapIndex ? t.snapIndex : t.activeIndex || 0, "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                ...
                if (s.dynamicBullets && (l = m.eq(0)[t.isHorizontal() ? "outerWidth" : "outerHeight"](!0), r.css(t.isHorizontal() ? "width" : "height", l * (s.dynamicMainBullets + 4) + "px"), s.dynamicMainBullets > 1 && void 0 !== t.previousIndex && ((n += c - (t.previousIndex - t.loopedSlides || 0)) > s.dynamicMainBullets - 1 ? n = s.dynamicMainBullets - 1 : n < 0 && (n = 0)), g = ((f = (h = Math.max(c - n, 0)) + (Math.min(m.length, s.dynamicMainBullets) - 1)) + h) / 2), m.removeClass(["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map(e => `${s.bulletActiveClass}${e}`).join(" ")), r.length > 1)
                    m.each(e => {
                        ...
                        s.dynamicBullets && (a >= h && a <= f && t.addClass(`${s.bulletActiveClass}-main`), a === h && p(t, "prev"), a === f && p(t, "next"))
                    });
                else {
                    let $ = m.eq(c),
                        v = $.index();
                    if ($.addClass(s.bulletActiveClass), s.dynamicBullets) {
                        let w = m.eq(h),
                            b = m.eq(f);
                        for (let _ = h; _ <= f; _ += 1)
                            m.eq(_).addClass(`${s.bulletActiveClass}-main`);
                        if (t.params.loop) {
                            if (v >= m.length) {
                ...
                if (s.dynamicBullets) {
                    let y = (l * Math.min(m.length, s.dynamicMainBullets + 4) - l) / 2 - g * l;
                    m.css(t.isHorizontal() ? e ? "right" : "left" : "top", `${y}px`)
                }
            }
            if ("fraction" === s.type && (r.find(N(s.currentClass)).text(s.formatFractionCurrent(c + 1)), r.find(N(s.totalClass)).text(s.formatFractionTotal(u))), "progressbar" === s.type) {
                ...
                let C = (c + 1) / u,
                    T = 1,
                    S = 1;
                "horizontal" === E ? T = C : S = C,
                r.find(N(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${T}) scaleY(${S})`).transition(t.params.speed)
            }
        ...
        a("click", (e, s) => {
            ...
            if (t.params.pagination.el && t.params.pagination.hideOnClick && r && r.length > 0 && !d(a).hasClass(t.params.pagination.bulletClass)) {
                if (t.navigation && (t.navigation.nextEl && a === t.navigation.nextEl || t.navigation.prevEl && a === t.navigation.prevEl))
                    return;
                i(!0 === r.hasClass(t.params.pagination.hiddenClass) ? "paginationShow" : "paginationHide"),
        ...
        function g() {
            ...
            l.hide && (clearTimeout(h), r[0].style.opacity = 1, h = setTimeout(() => {
                r[0].style.opacity = 0,
                r.transition(400)
            }, 1e3))
        }
        ...
        function w(e) {
            let {scrollbar: s, rtlTranslate: a} = t,
                {$el: i} = s,
                r;
            r = Math.max(Math.min(r = (v(e) - i.offset()[t.isHorizontal() ? "left" : "top"] - (null !== n ? n : o / 2)) / (p - o), 1), 0),
            a && (r = 1 - r);
        ...
        function _(e) {
            let s = t.device,
                ...
                r = t.zoom;
            if (!a.gestures) {
                if (!o || !p || "touchend" !== e.type || "touchend" === e.type && e.changedTouches.length < 2 && !s.android)
                    return;
                o = !1,
                p = !1
            }
        ...
        function x(e) {
            let s = t.zoom;
            if (!h.$imageEl || 0 === h.$imageEl.length || (t.allowClick = !1, !f.isTouched || !h.$slideEl))
                return;
            ...
            if (!(a < h.slideWidth && i < h.slideHeight)) {
                if (f.minX = Math.min(h.slideWidth / 2 - a / 2, 0), f.maxX = -f.minX, f.minY = Math.min(h.slideHeight / 2 - i / 2, 0), f.maxY = -f.minY, f.touchesCurrent.x = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX, f.touchesCurrent.y = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, !f.isMoved && !u && (t.isHorizontal() && (Math.floor(f.minX) === Math.floor(f.startX) && f.touchesCurrent.x < f.touchesStart.x || Math.floor(f.maxX) === Math.floor(f.startX) && f.touchesCurrent.x > f.touchesStart.x) || !t.isHorizontal() && (Math.floor(f.minY) === Math.floor(f.startY) && f.touchesCurrent.y < f.touchesStart.y || Math.floor(f.maxY) === Math.floor(f.startY) && f.touchesCurrent.y > f.touchesStart.y)))
        ...
        function k(e) {
            let {passiveListener: s} = S(),
                a = P();
            t.$wrapperEl[e]("gesturestart", a, w, s),
            t.$wrapperEl[e]("gesturechange", a, b, s),
            t.$wrapperEl[e]("gestureend", a, _, s)
        }
        function M() {
            n || (n = !0, k("on"))
        }
        ...
        function L() {
            ...
            let s = t.support,
                ...
                r = P();
            s.gestures ? (t.$wrapperEl.on(t.touchEvents.start, M, a), t.$wrapperEl.on(t.touchEvents.end, z, a)) : "touchstart" === t.touchEvents.start && (t.$wrapperEl.on(t.touchEvents.start, r, w, a), t.$wrapperEl.on(t.touchEvents.move, r, b, i), t.$wrapperEl.on(t.touchEvents.end, r, _, a), t.touchEvents.cancel && t.$wrapperEl.on(t.touchEvents.cancel, r, _, a)),
        ...
        function I() {
            ...
            let {passiveListener: a, activeListenerWithCapture: i} = S(),
                r = P();
            s.gestures ? (t.$wrapperEl.off(t.touchEvents.start, M, a), t.$wrapperEl.off(t.touchEvents.end, z, a)) : "touchstart" === t.touchEvents.start && (t.$wrapperEl.off(t.touchEvents.start, r, w, a), t.$wrapperEl.off(t.touchEvents.move, r, b, i), t.$wrapperEl.off(t.touchEvents.end, r, _, a), t.touchEvents.cancel && t.$wrapperEl.off(t.touchEvents.cancel, r, _, a)),
        ...
        Object.defineProperty(t.zoom, "scale", {
            ...
            set(e) {
                if ($ !== e) {
                    let t;
                    i("zoomChange", e, h.$imageEl ? h.$imageEl[0] : void 0, h.$slideEl ? h.$slideEl[0] : void 0)
                }
                $ = e
            }
        }),
        ...
        a("touchStart", (e, s) => {
            var a;
            let i;
            t.zoom.enabled && (a = s, i = t.device, h.$imageEl && 0 !== h.$imageEl.length && (f.isTouched || (i.android && a.cancelable && a.preventDefault(), f.isTouched = !0, f.touchesStart.x = "touchstart" === a.type ? a.targetTouches[0].pageX : a.pageX, f.touchesStart.y = "touchstart" === a.type ? a.targetTouches[0].pageY : a.pageY)))
        }),
        a("touchEnd", (e, s) => {
            t.zoom.enabled && function() {
                ...
                0 !== g.y && (a = Math.abs((n - f.currentY) / g.y));
                let o = Math.max(s, a);
                f.currentX = r,
                f.currentY = n;
        ...
        function c() {
            ...
            let h = [[o.left, o.top], [o.left + t.width, o.top], [o.left, o.top + t.height], [o.left + t.width, o.top + t.height], ];
        ...
        Object.assign(t.controller, {
            setTranslate: function(e, s) {
                ...
                function o(e) {
                    ...
                    "slide" === t.params.controller.by && (s = e, t.controller.spline || (t.controller.spline = t.params.loop ? new i(t.slidesGrid, s.slidesGrid) : new i(t.snapGrid, s.snapGrid)), l = -t.controller.spline.interpolate(-a)),
                ...
                if (Array.isArray(a))
                    for (let d = 0; d < a.length; d += 1)
                        a[d] !== s && a[d] instanceof n && o(a[d]);
                else
                    a instanceof n && s !== a && o(a)
            },
            setTransition: function(e, s) {
                ...
                function l(s) {
                    s.setTransition(e, t),
                    0 !== e && (s.transitionStart(), s.params.autoHeight && c(() => {
                        s.updateAutoHeight()
        ...
        let $ = (e, t, s) => {
            ...
            x = () => {
                ...
                t.$el.append(i);
                let r = t.$el;
                a.containerRoleDescriptionMessage && p(r, a.containerRoleDescriptionMessage),
                a.containerMessage && c(r, a.containerMessage);
                let l = t.$wrapperEl,
        ...
        a("fromEdge toEdge afterInit lock unlock", () => {
            t.params.a11y.enabled && function() {
                if (t.params.loop || t.params.rewind || !t.navigation)
                    return;
                let {$nextEl: e, $prevEl: s} = t.navigation;
                s && s.length > 0 && (t.isBeginning ? (u(s), n(s)) : (m(s), l(s))),
                e && e.length > 0 && (t.isEnd ? (u(e), n(e)) : (m(e), l(e)))
            }()
        }),
        a("paginationUpdate", () => {
            let e;
            t.params.a11y.enabled && (e = t.params.a11y, f() && t.pagination.bullets.each(s => {
                let a = d(s);
        ...
        let i = !1,
            ...
            o = e => {
                let t = r(),
                    s,
                    a = (s = e ? new URL(e) : t.location).pathname.slice(1).split("/").filter(e => "" !== e),
                    i = a.length;
                return {
                    key: a[i - 2],
                    value: a[i - 1]
            ...
            d = (e, s) => {
                ...
                let o = n(t.slides.eq(s).attr("data-history"));
                if (t.params.history.root.length > 0) {
                    let d = t.params.history.root;
                    "/" === d[d.length - 1] && (d = d.slice(0, d.length - 1)),
                    o = `${d}/${e}/${o}`
                } else
                    l.pathname.includes(e) || (o = `${e}/${o}`);
                t.params.history.keepQuery && (o += l.search);
                let p = a.history.state;
                p && p.value === o || (t.params.history.replaceState ? a.history.replaceState({
                    value: o
        ...
        a("init", () => {
            t.params.history.enabled && (() => {
                ...
                if (t.params.history) {
                    ...
                    i = !0,
                    ((l = o(t.params.url)).key || l.value) && (p(0, l.value, t.params.runCallbacksOnInit), t.params.history.replaceState || e.addEventListener("popstate", c))
                }
            })()
        }),
        a("destroy", () => {
            let e;
            t.params.history.enabled && (e = r(), t.params.history.replaceState || e.removeEventListener("popstate", c))
        }),
        ...
        let c = () => {
            ...
            u = () => {
                if (n && t.params.hashNavigation.enabled) {
                    if (t.params.hashNavigation.replaceState && p.history && p.history.replaceState)
                        p.history.replaceState(null, null, `#${t.slides.eq(t.activeIndex).attr("data-hash")}` || ""),
                        i("hashSet");
                    else {
        ...
        function u() {
            let e = a();
            "hidden" === e.visibilityState && s.autoplay.running && p(),
            "visible" === e.visibilityState && s.autoplay.paused && (n(), s.autoplay.paused = !1)
        }
        function m(e) {
        ...
        function l() {
            ...
            let s = e.clickedIndex,
                a = e.clickedSlide;
            if (a && d(a).hasClass(t.params.thumbs.slideThumbActiveClass) || null == s)
                return;
            let i;
        ...
        function o(e) {
            ...
            if (t.params.slidesPerView > 1 && !t.params.centeredSlides && (i = t.params.slidesPerView), t.params.thumbs.multipleActiveThumbs || (i = 1), i = Math.floor(i), s.slides.removeClass(r), s.params.loop || s.params.virtual && s.params.virtual.enabled)
                for (let l = 0; l < i; l += 1)
                    s.$wrapperEl.children(`[data-swiper-slide-index="${t.realIndex + l}"]`).addClass(r);
            else
                for (let n = 0; n < i; n += 1)
                    s.slides.eq(t.realIndex + n).addClass(r);
            ...
            if (t.realIndex !== s.realIndex || d) {
                ...
                if (s.params.loop) {
                    ...
                    p = void 0 === m ? h : void 0 === h ? m : h - u == u - m ? s.params.slidesPerGroup > 1 ? h : u : h - u < u - m ? h : m,
                    c = t.activeIndex > t.previousIndex ? "next" : "prev"
                } else
                    c = (p = t.realIndex) > t.previousIndex ? "next" : "prev";
                d && (p += "next" === c ? o : -1 * o),
                s.visibleSlidesIndexes && 0 > s.visibleSlidesIndexes.indexOf(p) && (s.params.centeredSlides ? p = p > u ? p - Math.floor(a / 2) + 1 : p + Math.floor(a / 2) - 1 : p > u && s.params.slidesPerGroup, s.slideTo(p, e ? 0 : void 0))
            }
        }
        t.thumbs = {
            swiper: null
                    ...
                    if (s < -t.minTranslate())
                        ...
                        if (r.freeMode.momentum) {
                            if (d.velocities.length > 1) {
                                ...
                                (f > 150 || u() - c.time > 300) && (t.velocity = 0)
                            } else
                                t.velocity = 0;
        ...
        i.grid = {
            ...
            updateSlide(e, r, l, n) {
                ...
                if ("row" === c && o > 1) {
                    ...
                    "column" === c ? (m = Math.floor(e / p), h = e - m * p, (m > a || m === a && h === p - 1) && (h += 1) >= p && (h = 0, m += 1)) : (h = Math.floor(e / s), m = e - h * s);
            ...
            updateWrapperSize(e, s, a) {
                ...
                if (i.virtualSize = (e + r) * t, i.virtualSize = Math.ceil(i.virtualSize / o) - r, i.$wrapperEl.css({
                    ...
                    for (let p = 0; p < s.length; p += 1) {
                        let c = s[p];
                        n && (c = Math.floor(c)),
                        s[p] < i.virtualSize + s[0] && d.push(c)
                    }
                    s.push(...d)
                }
            }
        ...
        q({
            ...
            setTranslate() {
                ...
                for (let g = 0; g < a.length; g += 1) {
                    ...
                    _ <= 1 && _ > -1 && (f = 90 * v + 90 * _, n && (f = -(90 * v) - 90 * _)),
                    $.transform(C),
                    c.slideShadows && i($, _, u)
                }
                if (s.css({
                ...
                s.transform(`translate3d(0px,0,${M}px) rotateX(${t.isHorizontal() ? 0 : f}deg) rotateY(${t.isHorizontal() ? -f : 0}deg)`),
                s[0].style.setProperty("--swiper-cube-translate-z", `${M}px`)
            },
            setTransition(e) {
                let {$el: s, slides: a} = t;
        ...
        q({
            ...
            setTranslate() {
                ...
                for (let r = 0; r < e.length; r += 1) {
                    ...
                    l[0].style.zIndex = -Math.abs(Math.round(n)) + e.length,
                    a.slideShadows && i(l, n, a);
        ...
        q({
            ...
            setTranslate() {
                ...
                for (let n = 0; n < e.length; n += 1) {
                    ...
                    t.params.centeredSlides && t.params.cssMode && (c -= e[0].swiperSlideOffset);
                    ...
                    let y = `translate3d(${u}, ${m}, ${h}px)rotateZ(${a.rotate ? g : 0}deg)scale(${p < 0 ? "" + (1 + (1 - f) * p) : "" + (1 - (1 - f) * p)})`;
                    if (a.slideShadows) {
